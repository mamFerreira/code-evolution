...
export class State extends MainState {     
    ...
    constructor(health: number, time: number, goals: Array<LevelGoal>) {
        ...
        this.regions.push(new Region(new Position(295, 25), new Position(345, 160)));
        ...
        this.regions.push(new Region(new Position(295, 197), new Position(345, 350)));                     
    }
